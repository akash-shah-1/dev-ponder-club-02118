            ...
            <Card className="mb-4 md:mb-6 border-primary/20 bg-primary/5">
              <CardContent className="p-4 md:p-6">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1">
                    <h2 className="text-base md:text-lg font-semibold text-foreground mb-2">Question of the day</h2>
                    ...
                    <Link to={`/questions/${questionOfDay.id}`}>
                      <Button size="sm" className="text-xs md:text-sm">Answer now</Button>
                    </Link>
                  </div>
                  <div className="w-20 md:w-32 flex items-center justify-center self-center md:self-auto">
                    <div className="text-center">
                      <div className="text-4xl md:text-6xl mb-1 md:mb-2">🏆</div>
                      <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-accent mx-auto flex items-center justify-center text-white text-base md:text-xl">
                        ✓
                      </div>
                    </div>
                  </div>
